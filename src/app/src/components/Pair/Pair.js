...
function Pair({id, name, ticker, blockchain, 
               price, volume, change}){
    ...
    return(
        <div key={id} className='grid auto-cols-auto md:grid-cols-4 grid-rows-1 p-4 hover:bg-secondary'>
            <div className='col-start-1 flex items-center'>
                <img src={`https://cryptoicons.org/api/color/${ticker.toLowerCase()}/100`} className='rounded-full w-9 h-9'/>
                <div className='ml-2'>
            ...
            <div className='col-start-2 flex items-center justify-center'>
                <p className={`font-medium text-sm md:ml-0
            ...
            <div className='col-start-3 justify-center hidden md:flex flex-col items-center'>
                <p className=' font-medium text-sm ml-4'>{volume}</p>
                <p className=' text-xs font-medium text-gray-500 ml-4'>{formatVolume(volume * price)}</p>
            </div>
            <div className='col-start-3 md:col-start-4 flex items-center justify-end md:justify-center'>
